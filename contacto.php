<?php
	...
	$arrayMerge = array_merge($arrayDoctors, $arrayProcedures);
  	...
  	if(isset($_POST['txtEmail']) && isset($_POST['txtName']) && isset($_POST['txtMessage']) && isset($_POST['txtEspecialidad']) && isset($_POST['txtCiudad'])){ 
		...
		$mail->Body = "El usuario ".$_POST['txtName']." especialista en: ".$_POST['txtEspecialidad']." de la ciudad: ".$_POST['txtCiudad']." con el correo ".$_POST['txtEmail']." lo quiere contactar con el siguiente mensaje: ".$_POST['txtMessage']."";
					...
					<div class="col m12">
						<form class="form-control" action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input name="txtCiudad" type="text" class="form-control" parsley-trigger="change" required placeholder=""/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">Especialidad</label>
								<div class="col-sm-6">
									<input name="txtEspecialidad" type="text" class="form-control" parsley-trigger="change" required placeholder=""/>
								</div>
							</div>
							<div class="form-group">
