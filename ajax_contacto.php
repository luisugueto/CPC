								...
								<td class="container">
									...
									<table class="main">
										...
										<td class="wrapper">
											...
											<tr>
												...
												<p>Has recibido un mensaje de: '.$_POST['txtName'].', desde: '.$_POST['txtCountry'].'</p>
												...
												<table border="0" cellpadding="0" cellspacing="0">
													...
													<tr>
														...
														<table border="0" cellpadding="0" cellspacing="0">
															<tbody>
															<tr>
																<td style="background-color:#fafafa; padding:15px 10px 0px 10px"><p>'.$_POST['txtMessage'].'</p></td>
															</tr>
															</tbody>
														</table>
														</td>
									...
									<div class="footer">
										...
										<tr>
											...
											<br>
											Estás recibiendo este correo a la dirección '.$_POST["DoctorEmail"].' porque está relacionada con el portal. Si recibiste este mensaje por equivocación puedes ignorarlo.
											</td>
										</tr>
										<tr>
...
<div class="modal-dialog modal-lg">
	...
	<div class="close-modal" onclick="closePrincipalModal()">
      ...
      <div class="modal-footer">
	  	<button id="submitButton" class="btn btn-default waves-effect waves-light" style="background-color:#00A5E1" onclick="submitModalsSite('contacto', 'Enviado Correctamente', 'Hemos enviado tus datos a <?= strtoupper($registro['Name']) ?> correctamente. Pronto se pondrá en contacto contigo.');">Enviar</button>
