		...
		<div class="wrapper">
			<div class="container">
				...
				?>
					...
					<form method="POST" onsubmit="CreateArticle(this); return false;" enctype="multipart/form-data">
								...
								<div class="search-result-box">
									<div class="card-box">
										...
										<div class="form-group">
											<label>Título:</label>
											<input type="text" id="txtTitle" name="txtTitle" class="form-control" style="text-transform:none;" onblur="createSlug(this)">
										</div>

										<div class="form-group">
											<label>Contenido:</label>
											<textarea id="txtContent" name="txtContent" class="ckeditor" rows="4" style="text-transform:none;"></textarea>
										</div>
										...
										<div class="form-group">
											...
											<input type="text" id="txtMetaTitle" name="txtMetaTitle" class="form-control" style="text-transform:none;">
										</div>

										<div class="form-group">
											<label>Meta descripción:</label>
											<textarea id="txtMetaDescription" name="txtMetaDescription" class="form-control" style="text-transform:none;" maxlength="200"></textarea>
										...
										<div class="form-group">
											...
											<br>
											http://www.cirugiaplasticacolombia.com/ <input type="text" id="slug-article" name="slug-article" class="form-control" style="text-transform:none;display:inline-block;width:50%;" onblur="createSlug(this)">
										</div>

										<div class="form-group">
											<label>Tags:</label>
											<input type="text" id="txtTags" name="txtTags" class="form-control" data-role="tagsinput" />
											<small>Separar con "," (comas)</small>
										</div>

										<div class="form-group">
											<label>ALT para imagen del artículo:</label>
											<input type="text" id="txtAltPhotos" name="txtAltPhotos" class="form-control" style="text-transform:none;">
										</div>
							...
							<div class="col-lg-4">
								<div class="search-result-box">
									<div class="card-box">
										...
										<div class="form-group">
											<label>Estado:</label> <input type="checkbox" name="statusCheck" data-size="medium" data-on-color="success" data-off-color="danger" name="chkStatus" id="chkStatus" data-on-text="Publica" data-off-text="Borrador">
										</div>

										<div class="form-group">
											<div class="input-group date" id='datetimepicker'>
												<input type="text" id="txtPublishDate" name="txtPublishDate" class="form-control" style="text-transform:none;">
